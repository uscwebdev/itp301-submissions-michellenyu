...
import Usercomments from './user.js';
import './index.css';
...
root.render(
  <React.StrictMode>
    ...
    <Usercomments
      ppic="https://i.pinimg.com/1200x/8d/0f/0c/8d0f0cd7d10f4914a9a7d7e6aad613fd.jpg"
      name="@Kei_Vibes"
      date="3 days ago"
      caption="Lexus has been my bias since the beginning and I am so proud of her!"
    />

    <Usercomments
      ppic="https://avatarfiles.alphacoders.com/843/84397.png"
      name="@myqueen_yuzuki"
      date="1 day ago"
      caption="Rooted for Savanna the whole show, I'm glad she debuted!"
    />

    <Usercomments
      ppic="https://i1.sndcdn.com/avatars-CXRDbH9Zx7n3M1YD-78GV8A-t500x500.jpg"
      name="@jannamaria"
      date="4 hours ago"
      caption="Kendall vc foi incrível querida! Boa sorte em sua estreia ❤❤"
    />

    <Usercomments
      ppic="https://i.pinimg.com/1200x/24/c9/d7/24c9d7db622d4604cf101ec5829e4afc.jpg"
      name="@Nami_swan"
      date="3 days ago"
      caption="I literally cried and started screaming and jumping around when i heard kaylee debuted.. im so proud of her!!😭 im so glad she made it❤"
    />
